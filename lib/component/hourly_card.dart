...
class HourlyCard extends StatelessWidget {
  ...
  final String region;
  const HourlyCard({Key? key, required this.darkColor, required this.lightColor, required this.category, required this.stats, required this.region}) : super(key: key);
